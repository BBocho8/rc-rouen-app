...
const MobileCartItem = ({ product }: MobileCartItemProps) => {
	const { onRemove } = useStateContext()

	return (
		<div className="flex items-center justify-between gap-x-2 py-2 px-8 ">
			<div className="flex items-center gap-x-2">
				...
				<div className=" flex flex-col items-start justify-center">
					<p className="text-sm tracking-wide font-medium  line-clamp-2 ">
						{product.name}
					</p>
